package pl.sda.clinicapi.service;
...
import pl.sda.clinicapi.exception.ConflictException;
import pl.sda.clinicapi.exception.ResourceNotFoundException;
import pl.sda.clinicapi.mapper.PatientsMapper;
import pl.sda.clinicapi.model.Patient;
import pl.sda.clinicapi.model.User;
import pl.sda.clinicapi.repository.PatientsRepository;
